...
from app.gui.components.process_controller import ProcessController
...
class ProcessRunner:
    def __init__(self, module: str, max_lines: int = 1000) -> None:
        ...
        self.controller = ProcessController(module=module, log=self.log)
    ...
    async def start(self):
        ...
        await self.controller.start(*self._build_args())
...
# class ProcessRunner_DELETE:  # TODO: delete
#     def __init__(self, module: str, max_lines: int = 1000) -> None:
#         self.module = module
